...
const Loader = () => (
  ...
  <div id="loader" className="fixed  overflow-hidden h-full w-full flex items-center justify-center md:gap-10 gap-3 text-start after:bg-blue-600
   after:absolute after:w-full after:h-4 after:-bottom-2 drop-shadow-xl select-none bg-slate-800 dark:text-white">
    ...
    <img className="w-28 md:w-52 rounded-3xl z-10 bottomm" src="./assets/fashion-boy-with-yellow-jacket-blue-pants (1).jpg" alt="" />
    <div className="topp">
      <h1 className="  md:text-3xl text-white drop-shadow">   Welocme    </h1>
      <h2 className="mt-2 text-sm md:text-2xl drop-shadow text-blue-500 font-semibold"><span className="text-white md:text-2xl  font-extrabold">karem fation</span> <br /> travel around the world </h2>
    </div>
